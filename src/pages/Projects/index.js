        ...
        <div className='page-estilo'>
            <Container>
                ...
                <Grid container md={12} className='botao-grupo'>
                    ...
                    <Grid item md={4}><CardProject title='Projeto B' text='Em processo de desenvolvmento. Envolve React, Solidity, Tecnologia Blockchain e mais' imgPath={imagem} wdt={345}/></Grid>
